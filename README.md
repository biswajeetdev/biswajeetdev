...
[![Skills](https://skillicons.dev/icons?i=python,nodejs,ts,postgres,react,fastapi,rust,git&theme=dark)](https://skillicons.dev)

**Stack:** Python · Node.js · TypeScript · Rust · SQL  
**AI / Agents:** Ollama · Whisper · FinBERT · RAG pipelines · MCP · Claude API · LLM orchestration  
**Infra:** FastAPI · PostgreSQL · Alpaca API · n8n · launchd · Docker
